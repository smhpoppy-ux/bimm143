...
```
>Q3. Improve this plot by completing the below code, which adds color, axis labels and cutoff lines:
...
```
>Q6 Can you do the same procedure as above to plot the pathview figures for the top 5 down-regulated pathways?
...
![pathview](hsa04110.pathview.png)
